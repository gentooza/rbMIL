/*
Copyright 2018 by it's authors (see AUTHORS)
...
////////////////////////////////////////////////////////////////////////////
//
// show_mask5 for ProcessViewServer created: Fri Jun 6 10:37:59 2014
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQPushButton(p,config_button,imagen_fondo);
  pvSetGeometry(p,config_button,3,3,120,60);
  pvSetText(p,config_button,pvtr("Configuración"));
  pvSetFont(p,config_button,"Arial",11,0,0,0,0);
  ...
  pvQFrame(p,frame_param,fondo,StyledPanel,Raised,2,1);
  pvSetGeometry(p,frame_param,3,100,395,497);
  pvSetPaletteBackgroundColor(p,frame_param,200,215,200);
  pvSetFont(p,frame_param,"Arial",11,0,0,0,0);

  pvQTable(p,table_param,frame_param,3,3);
  pvSetGeometry(p,table_param,3,40,389,454);
  pvSetFont(p,table_param,"Arial",11,0,0,0,0);

  pvQFrame(p,frame_users,fondo,StyledPanel,Raised,2,1);
  pvSetGeometry(p,frame_users,402,100,395,497);
  pvSetPaletteBackgroundColor(p,frame_users,200,215,200);
  pvSetFont(p,frame_users,"Arial",11,0,0,0,0);

  pvQTable(p,table_users,frame_users,3,4);
  pvSetGeometry(p,table_users,3,40,389,454);
  pvSetFont(p,table_users,"Arial",11,0,0,0,0);
