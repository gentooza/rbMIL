...
static int generated_defineMask(PARAM *p)
{
  ...
  pvSetGeometry(p,alarmHTML,5,5,650,590);
  pvSetFont(p,alarmHTML,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,ackAll,imagen_fondo);
  pvSetGeometry(p,ackAll,660,60,125,30);
  pvSetText(p,ackAll,pvtr("Ack All"));
  pvSetFont(p,ackAll,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,resetAll,imagen_fondo);
  pvSetGeometry(p,resetAll,660,100,125,30);
  pvSetText(p,resetAll,pvtr("Reset All"));
  pvSetFont(p,resetAll,"Sans Serif",10,0,0,0,0);

  pvQPushButton(p,button_return,imagen_fondo);
  pvSetGeometry(p,button_return,660,18,125,30);
  pvSetText(p,button_return,pvtr("volver"));
  pvSetFont(p,button_return,"Ubuntu",11,0,0,0,0);
