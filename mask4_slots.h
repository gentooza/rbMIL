...
*/
//###############################################################
//# mask4_slots.h for ProcessViewServer created: Mon Jun 9 13:18:39 2014
...
static int slotButtonReleasedEvent(PARAM *p, int id, DATA *d)
{
  char texto[100];
	int address;
  if(p == NULL || id == 0 || d == NULL) return -1;
  else if(id == button_return)
{
switch(	MyData.lastMask)
{
	case 1:
	show_mask1(p);
	break;
